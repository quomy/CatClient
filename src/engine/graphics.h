...
public:
	...
	void SetScreenAspectOverride(float Aspect) { m_ScreenAspectOverride = Aspect > 0.0f ? Aspect : 0.0f; }
	void ClearScreenAspectOverride() { m_ScreenAspectOverride = 0.0f; }
	bool HasScreenAspectOverride() const { return m_ScreenAspectOverride > 0.0f; }
