...
namespace
{
	...
	{
		pGraphics->DrawRect(X, Y, W, H, ModernUiBackgroundColor(), Corners, Rounding);
	}
}
...
void CHud::RenderTextInfo()
{
	...
	// render last-alive notify
	if(g_Config.m_TcNotifyWhenLast && GameClient()->m_GameInfo.m_EntitiesDDRace)
	{
		int NumInTeam = 0;
		int NumFrozen = 0;
		int LocalTeamID = 0;
