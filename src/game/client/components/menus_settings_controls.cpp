...
void CMenusSettingsControls::OnInterfacesInit(CGameClient *pClient)
{
	...
	m_vBindOptions = {
		...
		{EBindOptionGroup::DUMMY, Localizable("Dummy pseudo"), "+toggle cl_dummy_hammer 1 0"},
		{EBindOptionGroup::DUMMY, Localizable("Deepfly"), "+fire;+toggle cl_dummy_hammer 1 0"},
		{EBindOptionGroup::DUMMY, Localizable("Deepfly toggle"), "ri_deepfly_toggle"},
